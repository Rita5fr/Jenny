...
app = FastAPI(title="Jenny", version="0.4.0")
...
class QueryPayload(BaseModel):
    ...
    def ensure_payload(cls, values: "QueryPayload") -> "QueryPayload":  # type: ignore[name-defined]
        if not (values.text or values.voice_url or values.image_url):
