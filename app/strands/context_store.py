...
class SessionStore:
    ...
    async def _load_from_redis(self, user_id: str) -> Optional[SessionSnapshot]:
        ...
        try:
            ...
            logger.warning("Redis read failed for user %s, disabling Redis: %s", user_id, exc)
    ...
    async def _save_to_redis(self, user_id: str, snapshot: SessionSnapshot) -> None:
        ...
        try:
            ...
            logger.warning("Redis write failed for user %s, disabling Redis: %s", user_id, exc)
            self._redis_enabled = False
    ...
    async def _delete_from_redis(self, user_id: str) -> None:
        ...
        try:
            ...
            logger.warning("Redis delete failed for user %s, disabling Redis: %s", user_id, exc)
            self._redis_enabled = False
